<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MinTUPendiente.aspx.cs" Inherits="FETU.MinTUPendiente" Culture="en-US" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenedor2" runat="server">
    <div class="card-header text-center">
        <h5><b>CONSULTA MÍNIMA TASA DE USO PENDIENTE</b></h5>
    </div>
    <!-- Principal -->
    <div class="card-body">
        <div class="row">
    ...
    <div id="TasasPen" runat="server" visible="false" class="row" style="padding-top: 20px; display: flex; justify-content: center">
        <div class="" style="overflow-x: auto;">
            <asp:GridView ID="grdTasasPen" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False">
                <Columns>
                    <asp:BoundField DataField="TPNITTT" HeaderText="NIT Terminal" />
                    <asp:BoundField DataField="TPCODTERMINAL" HeaderText="Sede TT" />
